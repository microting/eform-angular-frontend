...
describe('Create folder', function () {
  ...
  it('Create folder child with name and description', function () {
    ...
    expect(rowCountBeforeCreation + 1, 'Number of rows hasn\'t changed after creating new folder')
  ...
  it('If cancel was clicked', function () {
    ...
    foldersPage.getFolderByName(nameFolder).createChild(generateRandmString(), generateRandmString(), true);
