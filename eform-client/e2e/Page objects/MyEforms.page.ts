...
class MyEformsRowObject {
  ...
  async getRow(rowNum: number) {
    ...
    this.element = (await $$('#mainPageEFormsTableBody tr.cdk-row'))[currentPosition];
    ...
    const val2 = (await $$(`#mainPageEFormsTableBody tr.cdk-row`))[currentPosition];
    ...
    this.editPairEformBtn = await (await $$(`#mainPageEFormsTableBody tr.cdk-row`))[
      currentPosition
    ].$('#eform-pairing-btn-' + (currentPosition));
    this.addPairEformBtn = await (await $$(`#mainPageEFormsTableBody tr.cdk-row`))[
      currentPosition
