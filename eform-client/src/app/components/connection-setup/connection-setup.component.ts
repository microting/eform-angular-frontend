...
@Component({
    ...
    imports: [EformNewSubheaderComponent, MatButton, ReactiveFormsModule, FormsModule, MatCard, MatCardHeader, MatCardContent, MatFormField, MatLabel, MatInput, MtxSelect, TranslatePipe]
})
