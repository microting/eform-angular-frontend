...
describe('ElementNumberComponent', () => {
  let component: ElementNumberComponent;
  let fixture: ComponentFixture<ElementNumberComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ElementNumberComponent);
