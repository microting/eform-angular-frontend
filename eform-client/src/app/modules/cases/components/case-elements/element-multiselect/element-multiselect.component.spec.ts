...
describe('ElementMultiselectComponent', () => {
  let component: ElementMultiselectComponent;
  let fixture: ComponentFixture<ElementMultiselectComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ElementMultiselectComponent);
