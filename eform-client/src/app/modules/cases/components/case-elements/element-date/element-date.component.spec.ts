...
describe('ElementDateComponent', () => {
  let component: ElementDateComponent;
  let fixture: ComponentFixture<ElementDateComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ElementDateComponent);
