...
describe('ElementSingleselectComponent', () => {
  let component: ElementSingleselectComponent;
  let fixture: ComponentFixture<ElementSingleselectComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ElementSingleselectComponent);
