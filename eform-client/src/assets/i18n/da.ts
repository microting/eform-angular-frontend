export const da = {
  ...
  'Forgot password title': 'Glemt adgangskode',
  'Restore password instructions': 'Indtast din e-mail adresse og tryk på Send. Nu modtager du en e-mail med anvisning på, hvordan du laver en ny adgangskode.',
  ...
  'Are you sure you want to confirm the email for': 'Er du sikker på, at du vil bekræfte e-mailen for',
  'Email confirmed': 'E-mail bekræftet',
  'Failed to confirm email': 'Kunne ikke bekræfte e-mail',
  Confirm: 'Bekræft',
  ...
  'PAGINATOR.NEXT_PAGE': 'Næste',
  'PAGINATOR.PREVIOUS_PAGE': 'Forrige',
  'PAGINATOR.FIRST_PAGE': 'Første',
  'PAGINATOR.LAST_PAGE': 'Sidste',
  'PAGINATOR.SHOW_ALL': 'Vis alle',
  ...
  'Direct dependencies': 'Direkte afhængigheder',
  'Transitive dependencies': 'Transitive afhængigheder',
  'All dependencies': 'Alle afhængigheder',
  'Search packages': 'Søg pakker',
  'Search by name or license': 'Søg efter navn eller licens',
  'Loading licenses': 'Indlæser licenser',
  Showing: 'Viser',
  of: 'af',
  packages: 'pakker',
};
