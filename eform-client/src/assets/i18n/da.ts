export const da = {
  ...
  Search: 'Søg',
  done_at: 'eForm færdig d.',
  created_at: 'Data tilgængelig d.',
  worker_name: 'eForm udført af',
  'Edit Case': 'Rediger sagen',
  'Delete Case': 'Slet sagen',
  Download: 'Download',
  'Are you sure you want to delete this case':
    'Er du sikker på, at du vil slette denne sag',
  ...
  Name: 'Navn',
  Ok: 'Ok',
  'Import options (max 100 entries)': `Importer 'valgmuligheder' (maks 100 elementer)`,
  Import: 'Importer',
  ...
  'Click to edit eForm pairing with user(s)':
    'Klik for at redigere eForm-parring med bruger(e)',
  ...
  'Select columns for displaying in Cases':
    'Vælg kolonner til visning i oversigt',
  Field: 'Felt',
  'Are you sure you want to delete': 'Er du sikker på, at du vil slette',
  'Creation Date': 'Oprettelsesdato',
  'Select tags for template': 'Vælg tags for eForm',
  'Template tags': 'eFormtags',
  'New tag': 'Nyt tag',
  'Tag list': 'Tag liste',
  Delete: 'Slet',
  ...
  'When pressing OK, you will deactivate the current device paired with this location':
    'Når du trykker på OK, vil du deaktivere den aktuelle enhed, der er parret med denne lokation',
  'If there is data on the current device, this data will be lost after pressing OK':
    'Hvis der er data på den aktuelle enhed, vil disse data gå tabt, når du har trykket på OK',
  Edit: 'Rediger',
  Sites: 'Lokationer',
  'Updated at': 'Opdateret d.',
  'Are you sure you want to delete the site? The action can not be undone':
    'Er du sikker på, at du vil slette siden? Handlingen kan ikke fortrydes',
  Previous: 'Tidligere',
  Next: 'Næste',
  Units: 'Enheder',
  ...
  'When pressing OK, you will deactivate the current unit assosiated with this location':
    'Når du trykker på OK, vil du deaktivere den aktuelle enhed, der er tilknyttet dette stedion',
  'You will se the new OTP code once you click OK':
    'Du vil se den nye OTP-kode, når du klikker på OK',
  Workers: 'Medarbejder',
  ...
  'Left empty if want to keep old':
    'Undlad at udfylde, hvis du ønsker at beholde din eksisterende adgangskode',
  Username: 'Brugernavn',
  Email: 'Email',
  Status: 'Status',
  'change will logout you from the application': 'ændringer vil logge dig ud',
  'Remove google authenticator secret key':
    'Fjern Google Authenticator-hemmelig nøgle',
  ...
  'Open Google Authenticator and add Eform application by scanning the QR Code to the right':
    'Åbn Google Authenticator og tilføj Eform applikation ved at scanne QR-koden til højre',
  'Enter the 6 digit code that Google Authenticator generates':
    'Indtast den 6-cifrede kode, som Google Authenticator genererer',
  General: 'Generelt',
  Find: 'Find',
  'Nothing found': 'Intet fundet',
  'Type in search box to see results':
    'Indtast i søgefelt for at se resultater',
  'Select tags for filter': 'Vælg tags for filter',
  'All selected': 'Alle markerede',
  'Showing to of records':
    'Viser {{currentPageAmount}} til {{currentPage}} ud af {{total}} poster',
  ...
  'If you leave before saving your changes will be lost':
    'Hvis du forlader, før du gemmer, vil dine ændringer gå tabt',
  ...
  'Are you sure you want to install plugin':
    'Er du sikker på, at du vil installere plugin',
  'This may take up to 10 minutes and rewrite current plugin version if it is already exist in the system':
    'Det kan tage op til 10 minutter og omskrive nuværende pluginversion, hvis den allerede findes i systemet',
  ...
  'Warning: you will be logged out when status is changed':
    'Advarsel: Du logges ud, når status ændres',
  ...
  'Tags management': 'Styring af tags',
  'Email/name text area should have at least one email/name pair':
    'Tekstområdet for email / navn skal have mindst et e-mail / navnepar',
  ...
  'Are you sure you want to delete menu entry':
    'Er du sikker på, at du vil slette menupunktet',
