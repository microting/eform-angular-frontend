export const noNO = {
  ...
  'New password confirmation': 'Nytt passordbekreftelse (minst 8 tegn)',
  'Confirm new password': 'Bekreft nytt passord (minst 8 tegn)',
  'Enter new password': 'Skriv inn nytt passord (minst 8 tegn)',
