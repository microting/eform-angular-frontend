export const slSL = {
  ...
  'New password confirmation': 'Potrditev novega gesla (najmanj 8 znakov)',
  'Confirm new password': 'Potrdite novo geslo (najmanj 8 znakov)',
  'Enter new password': 'Vnesite novo geslo (najmanj 8 znakov)',
