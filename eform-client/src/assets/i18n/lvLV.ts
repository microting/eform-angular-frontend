export const lvLV = {
  ...
  'New password confirmation': 'Jaunas paroles apstiprināšana (vismaz 8 rakstzīmes)',
  'Confirm new password': 'Apstipriniet jauno paroli (vismaz 8 rakstzīmes)',
  'Enter new password': 'Ievadiet jauno paroli (vismaz 8 rakstzīmes)',
