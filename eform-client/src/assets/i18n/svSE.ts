export const svSE = {
  ...
  'New password confirmation': 'Bekräftelse av nytt lösenord (minst 8 tecken)',
  'Confirm new password': 'Bekräfta nytt lösenord (minst 8 tecken)',
  'Enter new password': 'Ange nytt lösenord (minst 8 tecken)',
