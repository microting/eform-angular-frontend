export const ltLT = {
  ...
  'New password confirmation': 'Naujo slaptažodžio patvirtinimas (mažiausiai 8 simboliai)',
  'Confirm new password': 'Patvirtinkite naują slaptažodį (mažiausiai 8 simboliai)',
  'Enter new password': 'Įveskite naują slaptažodį (mažiausiai 8 simboliai)',
