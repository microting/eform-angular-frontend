export const enUS = {
  ...
  "Google Authenticator description":
    "<p>Secret key between <strong>Eform</strong> application and <strong>Google Authenticator</strong>. Keep itIT safe and do not tell anyone.</p><p>You should remove this key, if <strong>Google Authenticator</strong> is reinstalled or key was removed</p>",
