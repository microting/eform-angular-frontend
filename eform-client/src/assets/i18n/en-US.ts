export const enUS = {
  ...
  Search: 'Search',
  'eForm finished at': 'eForm finished at',
  'Data accessible at': 'Data accessible at',
  'eForm done by': 'eForm done by',
  'Edit Case': 'Edit Case',
  ...
  'Showing to of records':
    'Showing {{currentPageAmount}} to {{currentPage}} of {{total}} records',
  'Google Authenticator description':
    '<p>Secret key between <strong>Eform</strong> application and <strong>Google Authenticator</strong>. Keep it safe and do not tell anyone.</p><p>You should remove this key, if <strong>Google Authenticator</strong> is reinstalled or key was removed</p>',
