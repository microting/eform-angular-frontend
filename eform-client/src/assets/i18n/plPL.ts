export const plPL = {
  ...
  'New password confirmation': 'Potwierdzenie nowego hasła (min. 8 znaków)',
  'Confirm new password': 'Potwierdź nowe hasło (min. 8 znaków)',
  'Enter new password': 'Wpisz nowe hasło (min. 8 znaków)',
