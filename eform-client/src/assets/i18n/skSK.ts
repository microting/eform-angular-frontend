export const skSK = {
  ...
  'New password confirmation': 'Potvrdenie nového hesla (min. 8 znakov)',
  'Confirm new password': 'Potvrďte nové heslo (min. 8 znakov)',
  'Enter new password': 'Zadajte nové heslo (min. 8 znakov)',
