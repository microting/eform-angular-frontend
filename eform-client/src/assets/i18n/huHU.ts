export const huHU = {
  ...
  'New password confirmation': 'Új jelszó megerősítése (minimum 8 karakter)',
  'Confirm new password': 'Új jelszó megerősítése (minimum 8 karakter)',
  'Enter new password': 'Írja be az új jelszót (minimum 8 karakter)',
