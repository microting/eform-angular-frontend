export const ukUA = {
  ...
  'New password confirmation': 'Підтвердження нового пароля (мінімум 8 символів)',
  'Confirm new password': 'Підтвердьте новий пароль (мінімум 8 символів)',
  'Enter new password': 'Введіть новий пароль (мінімум 8 символів)',
