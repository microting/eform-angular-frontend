export const hrHR = {
  ...
  'New password confirmation': 'Potvrda nove lozinke (najmanje 8 znakova)',
  'Confirm new password': 'Potvrdite novu lozinku (najmanje 8 znakova)',
  'Enter new password': 'Unesite novu lozinku (najmanje 8 znakova)',
