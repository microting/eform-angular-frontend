export const ptPT = {
  ...
  'New password confirmation': 'Confirmação de nova senha (mínimo 8 caracteres)',
  'Confirm new password': 'Confirme a nova senha (mínimo 8 caracteres)',
  'Enter new password': 'Digite a nova senha (mínimo 8 caracteres)',
