export const nlNL = {
  ...
  'New password confirmation': 'Bevestiging van nieuw wachtwoord (min. 8 tekens)',
  'Confirm new password': 'Bevestig nieuw wachtwoord (min. 8 tekens)',
  'Enter new password': 'Voer een nieuw wachtwoord in (min. 8 tekens)',
