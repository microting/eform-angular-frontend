export const isIS = {
  ...
  'New password confirmation': 'Staðfesting nýtt lykilorð (lágmark 8 stafir)',
  'Confirm new password': 'Staðfestu nýtt lykilorð (lágmark 8 stafir)',
  'Enter new password': 'Sláðu inn nýtt lykilorð (lágmark 8 stafir)',
