export const itIT = {
  ...
  'New password confirmation': 'Conferma nuova password (min 8 caratteri)',
  'Confirm new password': 'Conferma nuova password (min 8 caratteri)',
  'Enter new password': 'Inserisci la nuova password (minimo 8 caratteri)',
