export const roRO = {
  ...
  'New password confirmation': 'Confirmarea parolei noi (min 8 caractere)',
  'Confirm new password': 'Confirmați parola nouă (min 8 caractere)',
  'Enter new password': 'Introduceți o nouă parolă (min 8 caractere)',
