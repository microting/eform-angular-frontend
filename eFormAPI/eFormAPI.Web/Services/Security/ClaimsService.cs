    ...
    public class ClaimsService : IClaimsService
    {
        ...
        public List<Claim> GetAllAuthClaims()
        {
            return new List<Claim>()
            {
                ...
                new Claim(AuthConsts.EformClaims.EformsClaims.CaseUpdate, AuthConsts.ClaimDefaultValue),
                new Claim(AuthConsts.EformClaims.EformsClaims.CaseDelete, AuthConsts.ClaimDefaultValue),
