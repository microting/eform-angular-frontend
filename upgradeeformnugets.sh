...
if (( "$GIT_STATUS" > 0 )); then
  ...
  CURRENT_NUMBER_OF_COMMITS=`git log --oneline | wc -l`
	...
	PACKAGES=('Microting.eForm' 'Microting.eFormApi.BasePn' 'AWSSDK.Core' 'AWSSDK.S3' 'Pomelo.EntityFrameworkCore.MySql' 'Magick.NET-Q16-x64' 'Microting.EformAngularFrontendBase' 'Microsoft.AspNetCore.Identity.UI' 'Microsoft.AspNetCore.Authentication.JwtBearer' 'Microsoft.AspNetCore.Mvc.NewtonsoftJson' 'Microsoft.EntityFrameworkCore.InMemory')
